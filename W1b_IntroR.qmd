...
-   Using spreadsheets? Limited options, change data accidentaly...
...
![RStudio Interface](W1b_IntroR_files/rstudio.png){fig-alt="Screenshot of the RStudio Interface with different panes visible"}
...
::: {.column width="50%"}
![RStudio Interface](W1b_IntroR_files/rstudio2.png)
:::
:::
...
![Console used as calculator](W1b_IntroR_files/Console.jpg){fig-alt="Calculated 100+1, 2*3, square root of 9 directly in the console"}
...
**Assignment**: In this file, write down some of the code (one command per line) that we have used so far and save the file. Write a comment (starting with #) at the end of each line that describes what is done in that line.\
...
-   **Assignment**: Please make a folder, e.g. called "Biostatistics" (but not "R" or anything with spaces in it)
:::
...
-   Delete and add some of the text on the white background. Change the Header (indicated by ##) to "About me" and write something about you underneath.
...
That's the lesson on "Getting started with R"! If you have any questions, feel free to ask me or post on MS Teams.
